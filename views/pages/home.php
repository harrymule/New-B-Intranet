              ...
              <article class="r_corners ">
                <figure>
                  <div class="m_bottom_20 r_corners wrapper simple_slideshow relative">
                    <ul class="slides">
                      <li><img src="views/template/images/blog_img_4.jpg" alt=""></li>
                      <li><img src="views/template/images/blog_img_5.jpg" alt=""></li>
                      <li><img src="views/template/images/blog_img_6.jpg" alt=""></li>
                    </ul>
                  </div>
                </figure>
              </article>
